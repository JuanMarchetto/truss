...
"#;
    ...
    let event_errors: Vec<_> = result.diagnostics
        .iter()
        .filter(|d| (d.message.contains("event") || d.message.contains("push") || d.message.contains("trigger")) && 
...
"#;
    ...
    let event_errors: Vec<_> = result.diagnostics
        .iter()
        .filter(|d| (d.message.contains("event") || d.message.contains("pull_request") || d.message.contains("trigger")) && 
                d.severity == Severity::Error)
        .collect();
...
"#;
    ...
    let event_errors: Vec<_> = result.diagnostics
        .iter()
        .filter(|d| (d.message.contains("event") || d.message.contains("workflow_dispatch") || d.message.contains("trigger")) && 
                d.severity == Severity::Error)
        .collect();
...
"#;
    ...
    let event_errors: Vec<_> = result.diagnostics
        ...
        .filter(|d| {
            ...
            (d.message.contains("event") || d.message.contains("push") || d.message.contains("tags") || d.message.contains("trigger")) && 
...
"#;
    ...
    let event_errors: Vec<_> = result.diagnostics
        .iter()
        .filter(|d| (d.message.contains("event") || d.message.contains("pull_request") || d.message.contains("type") || d.message.contains("trigger")) && 
...
"#;
    ...
    let event_errors: Vec<_> = result.diagnostics
        .iter()
        .filter(|d| (d.message.contains("event") || d.message.contains("issues") || d.message.contains("type") || d.message.contains("trigger")) && 
